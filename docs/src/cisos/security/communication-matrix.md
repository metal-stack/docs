...
| 2.2 4 |       metal-api        |  Metal Control Plane   |   TCP    |     masterdata-api     | Metal Control Plane  | 8443  |     |     |  x   |   x   |            Postgres            |                 Database access.                 |
...
|  2.8  |       metal-api        |  Metal Control Plane   |  HTTPS   |     S3-compatible      |       unknown        |  443  |  ?  |  ?  |  ?   |   ?   |            Firmware            |        Optional. Needs to be configured.         |
...
|  3.8  |    metal-apiserver     |  Metal Control Plane   |  HTTPS   |     S3-compatible      |       unknown        |  443  |  x  |  x  |  ?   |   ?   |            Firmware            |        Optional. Needs to be configured.         |
...
|  6.1  | backup-restore-sidecar |  Metal Control Plane   |  HTTPS   |     S3-compatible      |       unknown        |  443  |  ?  |  ?  |  ?   |   ?   |        Backup & Restore        |        Optional. Needs to be configured.         |
...
| 11.1  | metal-cache-image-sync |  Partition Management  |  HTTPS   |     S3-compatible      |       unknown        |  443  |  ?  |  ?  |  ?   |       |     Image Caching and Sync     |        Optional. Needs to be configured.         |
