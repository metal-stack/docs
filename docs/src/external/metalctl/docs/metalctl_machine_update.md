...
* [metalctl machine update bios](metalctl_machine_update_bios.md)	 - update a machine BIOS
* [metalctl machine update bmc](metalctl_machine_update_bmc.md)	 - update a machine BMC
